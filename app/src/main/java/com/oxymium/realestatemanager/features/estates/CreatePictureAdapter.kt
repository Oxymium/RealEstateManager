...
class CreatePictureAdapter(private val pictureDeleteListener: PictureDeleteListener, private val pictureCommentListener: PictureCommentListener): ListAdapter<Picture, CreatePictureViewHolder>(PictureDataAdapterListDiff()) {
    ...
    override fun onBindViewHolder(holder: CreatePictureViewHolder, position: Int) {
        holder.bind(getItem(position), pictureDeleteListener, pictureCommentListener)
    }
